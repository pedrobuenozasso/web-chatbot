...
export const UI_COPY: Record<UiLanguage, UiCopy> = {
  "pt-BR": {
    ...
    handoffKicker: "Triagem concluída", handoffTitle: "Seu atendimento pode continuar com uma pessoa do nosso time.", handoffBody: "Seu resumo já está preparado para você não precisar repetir tudo.", commercialButton: "Falar com o time comercial", openWhatsApp: "Abrir no WhatsApp", protocol: "Protocolo", error: "Não consegui concluir essa resposta agora. Aguarde um instante e tente novamente.", placeholder: "Digite sua mensagem...", messageLabel: "Mensagem", send: "Enviar mensagem", consent: "Ao continuar, você concorda com o uso dos dados para este atendimento.",
  },
  "pt-PT": {
    ...
    handoffKicker: "Triagem concluída", handoffTitle: "O seu atendimento pode continuar com uma pessoa da nossa equipa.", handoffBody: "O seu resumo já está preparado para não ter de repetir tudo.", commercialButton: "Falar com a equipa comercial", openWhatsApp: "Abrir no WhatsApp", protocol: "Protocolo", error: "Não consegui concluir esta resposta. Aguarde um instante e tente novamente.", placeholder: "Escreva a sua mensagem...", messageLabel: "Mensagem", send: "Enviar mensagem", consent: "Ao continuar, concorda com o uso dos dados para este atendimento.",
  },
  en: {
    ...
    handoffKicker: "Intake completed", handoffTitle: "You can now continue with a member of our team.", handoffBody: "Your summary is ready, so you won’t need to repeat everything.", commercialButton: "Talk to our sales team", openWhatsApp: "Open WhatsApp", protocol: "Reference", error: "I couldn’t complete that response right now. Please wait a moment and try again.", placeholder: "Type your message...", messageLabel: "Message", send: "Send message", consent: "By continuing, you agree to the use of your data for this service.",
  },
  de: {
    ...
    handoffKicker: "Erfassung abgeschlossen", handoffTitle: "Sie können nun mit einer Person aus unserem Team fortfahren.", handoffBody: "Ihre Zusammenfassung ist vorbereitet, damit Sie nichts wiederholen müssen.", commercialButton: "Mit dem Vertrieb sprechen", openWhatsApp: "WhatsApp öffnen", protocol: "Vorgang", error: "Die Antwort konnte gerade nicht abgeschlossen werden. Bitte versuchen Sie es gleich erneut.", placeholder: "Nachricht eingeben...", messageLabel: "Nachricht", send: "Nachricht senden", consent: "Wenn Sie fortfahren, stimmen Sie der Datennutzung für diese Beratung zu.",
  },
  fr: {
    ...
    handoffKicker: "Qualification terminée", handoffTitle: "Vous pouvez maintenant poursuivre avec un membre de notre équipe.", handoffBody: "Votre résumé est prêt, vous n’aurez donc pas à tout répéter.", commercialButton: "Parler à l’équipe commerciale", openWhatsApp: "Ouvrir WhatsApp", protocol: "Référence", error: "Je n’ai pas pu terminer cette réponse. Patientez un instant et réessayez.", placeholder: "Écrivez votre message...", messageLabel: "Message", send: "Envoyer le message", consent: "En continuant, vous acceptez l’utilisation de vos données pour cette assistance.",
  },
  es: {
    ...
    handoffKicker: "Clasificación completada", handoffTitle: "Ahora puede continuar con una persona de nuestro equipo.", handoffBody: "Su resumen ya está preparado para que no tenga que repetirlo todo.", commercialButton: "Hablar con el equipo comercial", openWhatsApp: "Abrir WhatsApp", protocol: "Referencia", error: "No pude completar esta respuesta. Espere un momento e inténtelo de nuevo.", placeholder: "Escriba su mensaje...", messageLabel: "Mensaje", send: "Enviar mensaje", consent: "Al continuar, acepta el uso de sus datos para esta atención.",
  },
};
