...
export const UI_COPY: Record<UiLanguage, UiCopy> = {
  ...
  "pt-PT": {
    ...
    handoffKicker: "Triagem concluída", handoffTitle: "O seu atendimento pode continuar com uma pessoa da nossa equipa.", handoffBody: "O seu resumo já está preparado para não ter de repetir tudo.", handoffConsent: "Ao clicar, concorda em ser contactado pela Zasso Brasil através do WhatsApp e declara que leu e aceita a nossa", commercialButton: "Falar com a equipa comercial", openWhatsApp: "Abrir no WhatsApp", meetingButton: "Marcar uma reunião", openMeeting: "Agendar horário", protocol: "Protocolo", error: "Não consegui concluir esta resposta. Aguarde um instante e tente novamente.", placeholder: "Escreva a sua mensagem...", messageLabel: "Mensagem", send: "Enviar mensagem", consent: "Ao continuar, concorda com o uso dos dados para este atendimento.", privacyPolicy: "Política de Privacidade",
  },
  en: {
    ...
    handoffKicker: "Intake completed", handoffTitle: "You can now continue with a member of our team.", handoffBody: "Your summary is ready, so you won’t need to repeat everything.", handoffConsent: "By clicking, you agree to be contacted by Zasso Brasil on WhatsApp and confirm that you have read and accept our", commercialButton: "Talk to our sales team", openWhatsApp: "Open WhatsApp", meetingButton: "Schedule a meeting", openMeeting: "Book a time", protocol: "Reference", error: "I couldn’t complete that response right now. Please wait a moment and try again.", placeholder: "Type your message...", messageLabel: "Message", send: "Send message", consent: "By continuing, you agree to the use of your data for this service.", privacyPolicy: "Privacy Policy",
  },
  de: {
    ...
    handoffKicker: "Erfassung abgeschlossen", handoffTitle: "Sie können nun mit einer Person aus unserem Team fortfahren.", handoffBody: "Ihre Zusammenfassung ist vorbereitet, damit Sie nichts wiederholen müssen.", handoffConsent: "Mit dem Klick stimmen Sie einer Kontaktaufnahme durch Zasso Brasil über WhatsApp zu und bestätigen, dass Sie unsere Datenschutzerklärung gelesen haben und akzeptieren:", commercialButton: "Mit dem Vertrieb sprechen", openWhatsApp: "WhatsApp öffnen", meetingButton: "Termin vereinbaren", openMeeting: "Zeit buchen", protocol: "Vorgang", error: "Die Antwort konnte gerade nicht abgeschlossen werden. Bitte versuchen Sie es gleich erneut.", placeholder: "Nachricht eingeben...", messageLabel: "Nachricht", send: "Nachricht senden", consent: "Wenn Sie fortfahren, stimmen Sie der Datennutzung für diese Beratung zu.", privacyPolicy: "Datenschutzerklärung",
  },
  fr: {
  ...
  es: {
    ...
    handoffKicker: "Clasificación completada", handoffTitle: "Ahora puede continuar con una persona de nuestro equipo.", handoffBody: "Su resumen ya está preparado para que no tenga que repetirlo todo.", handoffConsent: "Al hacer clic, acepta que Zasso Brasil se comunique con usted por WhatsApp y declara que ha leído y acepta nuestra", commercialButton: "Hablar con el equipo comercial", openWhatsApp: "Abrir WhatsApp", meetingButton: "Agendar una reunión", openMeeting: "Reservar un horario", protocol: "Referencia", error: "No pude completar esta respuesta. Espere un momento e inténtelo de nuevo.", placeholder: "Escriba su mensaje...", messageLabel: "Mensaje", send: "Enviar mensaje", consent: "Al continuar, acepta el uso de sus datos para esta atención.", privacyPolicy: "Política de privacidad",
  },
};
